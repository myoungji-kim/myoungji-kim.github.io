...
### 🧩 <b>파스트리</b>
- 일반적으로 컴파일러나 인터프리터는 <u>파스 트리</u>를 구성한다.
> [파스 트리](https://blog.naver.com/PostView.nhn?blogId=qfqf8505&logNo=221390581784&parentCategoryNo=&categoryNo=27&viewDate=&isShowPopularPosts=true&from=search) : 언어 문법으로부터 만들어낸 DAG 데이터 구조, 올바른 문장을 트리 구조로 나타낸 것

---

### 🧩 <b>컴파일과 인터프리트</b>

- 고수준 언어를 실행하는 방법으로는 컴파일 외에 <u>인터프리트</u>도 있다.
- 영어 책을 우리말로 번역하는 것에 비유하자면,
  - 컴파일은 책 전문을 모두 번역한 다음에, 번역한 책을 사람들에게 공유하는 것과 같다.
  - 인터프리트는 책을 읽으면서 우리말로 즉시 번역해 읽어주는 것과 같다.
<br>
- 대표적인 인터프리터 언어로는 파이썬, PHP 등이 있다.

#### <span style="background-color:#fff5b1;"><b>인터프리터</b></span>




#### <span style="background-color:#fff5b1;"><b>컴파일</b></span>
